local strings = {
	...
	["SI_VOTANS_MAPPIN_COLORS_SHOW_PLAYER_PIN"] = "Afficher le marqueur du personnage",
	["SI_VOTANS_MAPPIN_COLORS_SHOW_PLAYER_PIN_TOOLTIP"] = "Permet de cacher le marqueur de position du personnage sur la carte. Utile pour jouer en mode immersif.",
	["SI_VOTANS_MAPPIN_COLORS_PLAYER_PIN_VIBRATION"] = "Vibration du marqueur",
	["SI_VOTANS_MAPPIN_COLORS_PLAYER_PIN_VIBRATION_TOOLTIP"] = "Fait vibrer brièvement le marqueur du joueur à l'ouverture de la carte pour faciliter son repérage.",
}
