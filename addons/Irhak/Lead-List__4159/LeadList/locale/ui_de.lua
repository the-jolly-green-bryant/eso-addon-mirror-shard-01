...
ILL.ZONENAME_ALLZONES = "Alle Zonen"
ILL.ZONENAME_BGS = "Schlachtfelder"

ILL.KEYBINDINGTEXT = "Display Leads Fenster umschalten"
...
ILL.DropdownData = {
	...
	ChoicesZone = {ILL.ZONENAME_ALLZONES, "Aktuelle Zone", "Neuester DLC", "Ohne DLCs", "Event Zone",},
	TooltipsZone = { 
...
ILL.LABEL_ALERTS_UD_MISSING = "|c%sAchtung: %d 7D; %d 1D; %d 1H|r"

ILL.LABEL_ALERTS = "|c%sAchtung: %d <7D; %d <1D; %d <1H; Codex: %d|r"
...
ILL.TOOLTIP_ALERTS_1HOUR = "Auslaufende Spur < 1 Stunde : %d"
ILL.TOOLTIP_ALERTS_1DAY = "Auslaufende Spur < 1 Tag : %d"
ILL.TOOLTIP_ALERTS_7DAYS = "Auslaufende Spur < 7 Tage : %d"
...
ILL.TOOLTIP_ALERTS_UD_NONEFOUND = "Keine Unerschrockenen-Daily hat eine Spur für Dich"
ILL.TOOLTIP_ALERTS_UD_SCRYFIRST = " (Du hast die Spur bereits. Suche/Erspähe sie zuerst)"

ILL.LABEL_URL_INITIAL = "Bisher keine Spur entdeckt"
ILL.LABEL_URL_LEADFOUND = "|c3A92FFNeuen Fund melden, ID %d|r"
...
ILL.EDITBOX_INITIAL = "Wenn Du einen neuen Standort findest: Ersetze was hier steht und klicke dann auf 'Neuen Standort melden'."
ILL.EDITBOX_LOCATION_DATA_COMPLETE = "Bitte nur einreichen, wenn Dein Fund nicht bereits durch eine bestehende Beschreibung abgedeckt ist."
ILL.EDITBOX_NO_LEAD_FOUND_OR_SELECTED = "Finde zuerst die neue Spur, klicke dann auf die Spur, welche Du melden möchtest"
ILL.EDITBOX_NOT_EDITED = "Um einen neuen Fund einzureichen: Ersetze zunächst den Inhalt dieser Editbox durch Deinen neuen Standort. Klicke dann auf 'Neuen Standort melden'."
ILL.EDITBOX_LOCDATA_EMPTY = "Du musst Deinen neuen Standort in diesem Feld eingeben. Klicke dann auf 'Neuen Standort melden'."
ILL.EDITBOX_THANKS = "Danke für die Übermittlung des neuen Standortes."

ILL.SORTHEADER_NAMES = { "Spur", "Zone", "Ort",  "Kodex", "Anz.", "Set/Art", "Restzeit", }
