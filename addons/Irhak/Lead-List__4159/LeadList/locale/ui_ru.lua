...
ILL.ZONENAME_ALLZONES = "Все зоны"
ILL.ZONENAME_BGS = "Поля сражений"

ILL.KEYBINDINGTEXT = "Открыть окно Display Leads"
...
ILL.DropdownData = {
	...
	ChoicesZone = {ILL.ZONENAME_ALLZONES, "Текущая зона", "Latest DLC", "Исключить второстепенные DLC", "Event Zone"},
	TooltipsZone = { 
...
ILL.LABEL_ALERTS_UD_MISSING = "|c%sПредупреждения : %d 7Д; %d 1Д; %d 1Ч|r"

ILL.LABEL_ALERTS = "|c%sПредупреждения : %d <7Д; %d <1Д; %d <1Ч; Codex: %d|r"
...
ILL.TOOLTIP_ALERTS_1HOUR = " Срок действия зацепки истекает через < 1 час : %d"
ILL.TOOLTIP_ALERTS_1DAY = " Срок действия зацепки истекает через < 1 день : %d"
ILL.TOOLTIP_ALERTS_7DAYS = " Срок действия зацепки истекает через < 7 дней : %d"
...
ILL.TOOLTIP_ALERTS_UD_NONEFOUND = "В ежедневных заданиях Неустрашимых нет зацепок для вас"
ILL.TOOLTIP_ALERTS_UD_SCRYFIRST = " (У вас уже есть эта зацепка, для начала Лоцируйте/Выкопайте)"

ILL.LABEL_URL_INITIAL = "На данный момент зацепок не обнаружено"
ILL.LABEL_URL_LEADFOUND = "|c3A92FFСообщить о последней зацепке с ID %d|r"
...
ILL.EDITBOX_INITIAL = "Если вы найдете НОВОЕ местоположение: замените то, что здесь написано; Нажмите «Ярлык» слева, чтобы отправить в браузер."
ILL.EDITBOX_LOCATION_DATA_COMPLETE = "Информация о местоположении считается полной. Отправляйте только в том случае, если ваша находка еще не включена в существующее описание."
ILL.EDITBOX_NO_LEAD_FOUND_OR_SELECTED = "Сначала найдите зацепку или щелкните строку зацепки, о которой вы хотите сообщить."
ILL.EDITBOX_NOT_EDITED = "Чтобы отправить новую находку: сначала замените то, что находится в этом поле редактирования, вашим новым местоположением. Затем нажмите «Ярлык» слева."
ILL.EDITBOX_LOCDATA_EMPTY = "Вам необходимо ввести новое местоположение в это поле редактирования. Затем нажмите «Ярлык» слева."
ILL.EDITBOX_THANKS = "Спасибо за отправку новых данных о местоположении."

ILL.SORTHEADER_NAMES = { "Зацепки", "Зоны", "Местоположения", "Кодекс", "Выкопанные", "Наборы", "Срок действия", }
