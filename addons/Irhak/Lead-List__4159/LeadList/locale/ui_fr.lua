...
ILL.ZONENAME_ALLZONES = "Toutes Zones"
ILL.ZONENAME_BGS = "Champ de batailles"

ILL.KEYBINDINGTEXT = "Fenétre de Changement d'affichage des pistes"
...
ILL.DropdownData = {
	...
	ChoicesZone = {ILL.ZONENAME_ALLZONES, "Zone actuelle", "dernière DLC", "Exclus les DLC mineur", "Event Zone",},
	TooltipsZone = { 
...
ILL.LABEL_ALERTS_UD_MISSING = "|c%sAlertes : %d 7D; %d 1D; %d 1H|r"

ILL.LABEL_ALERTS = "|c%sAlertes : %d <7D; %d <1D; %d <1H; Codex: %d|r"
...
ILL.TOOLTIP_ALERTS_1HOUR = " Pistes expirant dans < 1 heure : %d"
ILL.TOOLTIP_ALERTS_1DAY = " Pistes expirant dans < 1 jour : %d"
ILL.TOOLTIP_ALERTS_7DAYS = " Pistes expirant dans < 7 jour : %d"
...
ILL.TOOLTIP_ALERTS_UD_NONEFOUND = "Non Undaunted Dailies n'a pas de pistes pour vous"
ILL.TOOLTIP_ALERTS_UD_SCRYFIRST = " (Vous avez déjà cette piste, localiser / fouillez-le d'abord)"

ILL.LABEL_URL_INITIAL = "0 Piste découverte jusqu’ici"
ILL.LABEL_URL_LEADFOUND = "|c3A92FFSignaler la piste avec ID %d|r"
...
ILL.EDITBOX_INITIAL = "Si vous trouvez un NOUVEL emplacement: remplacez ce qui apparaîtra ici; Cliquez sur l'étiquette à gauche pour envoyer"
ILL.EDITBOX_LOCATION_DATA_COMPLETE = "Informations de localisation considérées comme complètes. Veuillez soumettre uniquement si votre recherche n'est pas déjà couverte par une description existante"
ILL.EDITBOX_NO_LEAD_FOUND_OR_SELECTED = "Recherchez d'abord une piste ou cliquez sur la ligne de piste que vous souhaitez signaler."
ILL.EDITBOX_NOT_EDITED = "Pour soumettre une nouvelle recherche: Remplacez d'abord ce qui se trouve dans cette boîte d'édition par votre nouvel emplacement. Cliquez ensuite sur l'étiquette à gauche."
ILL.EDITBOX_LOCDATA_EMPTY = "Vous devez entrer votre nouvel emplacement dans cette boîte d'édition. Cliquez ensuite sur l'étiquette à gauche."
ILL.EDITBOX_THANKS = "Merci d'avoir soumis de nouvelles données de localisation"

ILL.SORTHEADER_NAMES = { "Pistes", "Zone", "Emplacement", "Conn", "Creusé", "Ensemble", "Expiration", }
ILL.SORTHEADER_TOOLTIP = {
	...
	"Délai jusqu'à l'expiration de la piste.\n Pour certaines pistes, le délai d'expiration ne diminue pas pendant les deux premiers jours.",
}
...
ILL.TOOLTIP_MAPPINS = "Inclus dans MapPins Addon de Hoft"
