...
try {
	...
	foreach ($BasePath in "Elder Scrolls Online/live", "~/Documents/Elder Scrolls Online/live") {
		$HarvestMapPath="${BasePath}/AddOns/HarvestMapData"
	...
	echo "The script could not find the HarvestMapData AddOn and your SavedVariables folder."
	echo "Make sure the HarvestMapData AddOn and this script are installed in"
