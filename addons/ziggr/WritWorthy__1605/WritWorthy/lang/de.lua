...
WritWorthy.I18N["static"]["de"] = {
  ...
  ["lam_mm_price_desc"] = "Master Merchant über LibPrice verwenden, um Materialpreise abzurufen.",
  ["lam_mm_price_title"] = "MM-Preise verwenden",

  ["lam_att_price_desc"] = "Arkadius Trade Tools über LibPrice verwenden, um Materialpreise abzurufen.",
  ["lam_att_price_title"] = "ATT-Preise verwenden",

  ["lam_ttc_price_desc"] = "Tamriel Trade Centre über LibPrice verwenden, um Materialpreise abzurufen.",
  ["lam_ttc_price_title"] = "TTC-Preise verwenden",
