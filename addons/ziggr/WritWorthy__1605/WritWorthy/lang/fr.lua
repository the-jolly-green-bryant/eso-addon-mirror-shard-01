...
WritWorthy.I18N["static"]["fr"] = {
  ...
  ["lam_mm_price_desc"] = "Utiliser Master Merchant via LibPrice pour obtenir les prix des matériaux.",
  ["lam_mm_price_title"] = "Utiliser les prix MM",

  ["lam_att_price_desc"] = "Utiliser Arkadius Trade Tools via LibPrice pour obtenir les prix des matériaux.",
  ["lam_att_price_title"] = "Utiliser les prix ATT",

  ["lam_ttc_price_desc"] = "Utiliser Tamriel Trade Centre via LibPrice pour obtenir les prix des matériaux.",
  ["lam_ttc_price_title"] = "Utiliser les prix TTC",
