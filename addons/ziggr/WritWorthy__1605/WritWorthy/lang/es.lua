...
WritWorthy.I18N["static"]["es"] = {
  ...
  ["lam_banked_vouchers_desc"] = "Escanea el banco e incluye esos encargos en la lista de encargos disponibles para fabricar automaticamente.\n|cFF3333TEN CUIDADO si fabricas con varios personajes! WritWorthy no te avisara si fabricas el mismo encargo del banco con varios personajes.|r",
  ["lam_banked_vouchers_title"] = "Incluir encargos del banco en la ventana de fabricacion automatica",
  ["lam_force_en_desc"] = "Ignorar el idioma del cliente y usar ingles EN para todo el texto de WritWorthy.",
  ["lam_force_en_title"] = "Forzar ingles EN",
  ["lam_mat_list_alchemy_only"] = "Solo Alquimia",
  ["lam_mat_list_all"] = "Todo",
  ["lam_mat_list_desc"] = "Escribe varias lineas de materiales en el chat cada vez que aparece el tooltip de una orden maestra.",
  ["lam_mat_list_off"] = "Desactivado",
  ["lam_mat_list_title"] = "Mostrar lista de materiales en el chat",
  ["lam_mat_price_tt_desc"] = "Agrega texto al tooltip con el costo de todos los materiales que se consumirian al fabricar este encargo.",
  ["lam_mat_price_tt_title"] = "Mostrar precio de materiales en el tooltip",
  ["lam_mm_price_desc"] = "Usar Master Merchant mediante LibPrice para obtener precios de materiales.",
  ["lam_mm_price_title"] = "Usar precios de MM",

  ["lam_att_price_desc"] = "Usar Arkadius Trade Tools mediante LibPrice para obtener precios de materiales.",
  ["lam_att_price_title"] = "Usar precios de ATT",

  ["lam_ttc_price_desc"] = "Usar Tamriel Trade Centre mediante LibPrice para obtener precios de materiales.",
  ["lam_ttc_price_title"] = "Usar precios de TTC",
  ["lam_station_colors_desc"] = "Usar colores diferentes para herreria, sastreria y carpinteria en la ventana de WritWorthy.",
  ["lam_station_colors_title"] = "Colores de estacion en la ventana",
  ["lam_cmw_desc"] = "Si prefieres los tooltips de Confirm Master Writ de Marify, desactiva esta opcion para ocultar los avisos redundantes de WritWorthy.",
  ["lam_cmw_title"] = "Mostrar tooltips duplicados",
  ["lam_mat_tooltip_title"] = "Mostrar materiales en el tooltip",
  ["lam_mat_tooltip_desc"] = "Mostrar lista de materiales en el tooltip",
  ["lam_mat_tooltip_off"] = "Desactivado",
  ["lam_mat_tooltip_all"] = "Todo",
  ["lam_mat_tooltip_missing_only"] = "Solo faltantes",
  ...
  ["header_reset_window_pos"] = "Restablecer posicion de la ventana",
  ["name_reset_window_pos"] = "Restablecer posicion de la ventana",
  ["tooltip_reset_window_pos"] = "Restablece la posicion de la ventana."
}
