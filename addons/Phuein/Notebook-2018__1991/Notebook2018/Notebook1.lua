	...
	if currentlyViewing == btnID then
		AddMenuItem(GetString(SI_NBUI_CONTEXT_COPYFROMMAIL), function()
			...
			if MAIL_INBOX.selectedData then
				...
				NBUI.NB1RightPage_Title:SetText(subject)
				NBUI.NB1RightPage_Title:SetCursorPosition(0)

				NBUI.NB1RightPage_Contents:SetText(body)
...
function Create_NB1_IndexButton(NB1_IndexPool)
	...
	button:SetHandler("OnClicked", function(self, button , ctrl , alt , shift , command)
		...
		NBUI.NB1RightPage_Contents:SetText(text)
		NBUI.NB1RightPage_Contents:SetCursorPosition(0)
...
-----------------------------------`----------------------------------------------------------------
	NBUI.NB1LeftPage_Title = WINDOW_MANAGER:CreateControl("NBUI_NB1LeftPage_Title", NBUI.NB1MainWindow, CT_LABEL)
		...
		NBUI.NB1LeftPage_Title:SetDrawTier(1)
...
---------------------------------------------------------------------------------------------------
	NBUI.NB1RightPage_Title = WINDOW_MANAGER:CreateControlFromVirtual("NBUI_NB1RightPage_Title", NBUI.NB1RightPage_TitleBackdrop, "ZO_DefaultEditForBackdrop")
		...
		NBUI.NB1RightPage_Title:SetDrawTier(1)
...
function NBUI.NB1SavePage(self)
	...
	local safe_titleText = titleText
	local safe_pageText = pageText
